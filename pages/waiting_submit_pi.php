        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formEdit">
                    ...
                    <!-- SECTION 1: PI INFORMATION -->
                    <div class="card mb-3">
                        <div class="card-header bg-light">
                            <strong>📋 PI Information</strong>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label">No PI</label>
                                    <input type="text" class="form-control" id="edit_no_pi" name="no_pi" placeholder="Enter PI number" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Date Submit PI <span class="text-danger">*</span></label>
                                    <input type="date" class="form-control date-picker" id="edit_date_submit_pi" name="date_submit_pi" placeholder="YYYY-MM-DD" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Date Send HCPOD</label>
                                    <input type="date" class="form-control date-picker" id="edit_date_send_hc_pod" name="date_send_hc_pod" placeholder="DD-MM-YYYY" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control rupiah-input" id="edit_unit_price" name="unit_price" placeholder="0" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
