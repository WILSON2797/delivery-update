                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">
                                        ATD Whs Dispatch
                                        <span class="text-muted small">- Berangkat Dari WH</span>
                                    </label>
                                    <div class="row g-2">
                                        <div class="col-5">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">
                                        ATD Pool Dispatch
                                        <span class="text-muted small">- Berangkat Dari Pool</span>
                                    </label>
                                    <div class="row g-2">
                                        <div class="col-5">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">
                                        ATA Mover on Site
                                        <span class="text-muted small">- Mover Onsite</span>
                                    </label>
                                    <div class="row g-2">
                                        <div class="col-5">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="remarks" id="edit_remarks" class="form-control" placeholder="e.g:Actual Receiver : Budi | PT.ABCD" rows="4"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
