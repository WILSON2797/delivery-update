    ...
    <div class="container-fluid px-4 mt-4">
        <div class="card mb-4">
            <div class="card-header">
                ...
                <div class="float-end">
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#destinationModal">
            ...
            <div class="card-body" style="overflow-x: auto;">
                <div class="table-responsive" style="overflow-x: auto;">
                    <table class="table table-striped table-hover table-bordered compact-action" id="tabeldestination"
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="destinationModalLabel">Tambah destination</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="destinationForm" action="../modules/proses_destination.php" method="POST">
                    <div class="row mb-2">
                        <div class="col-md-12">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="city" class="form-control" placeholder="Contoh: KOTA_BEKASI_IDN" required>
                        </div>
                    </div>
