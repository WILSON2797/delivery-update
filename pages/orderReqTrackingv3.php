                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="plan_from" id="track_plan_from" class="form-control" required>
                                </div>
                                
                                <div class="col-md-6">
                                    <label class="form-label">Destination City <span class="text-danger">*</span></label>
                                    <input type="text" name="destination_city" id="track_destination_city" class="form-control" required>
                                </div>

                                <!-- BARIS 4 -->
                                <div class="col-md-6">
                                    <label class="form-label">Destination Province <span class="text-danger">*</span></label>
                                    <input type="text" name="destination_province" id="track_destination_province" class="form-control" required>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select name="mot" id="track_mot" class="form-control" required>
                                        ...
                                        <option value="2-WINGBOX">2-WINGBOX</option>
                                        <option value="4-WINGBOX">4-WINGBOX</option>
                                        <option value="6-WINGBOX">6-WINGBOX</option>
                                        <option value="9-WINGBOX">9-WINGBOX</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="type_shipment" id="track_type_shipment" class="form-control">
                                </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <!-- BARIS 1 -->
                                <div class="col-md-6">
                                    <label class="form-label">Truck on Warehouse <span class="text-muted small">- Berangkat Dari WH</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                        <input type="text" name="truck_on_warehouse" id="track_truck_on_warehouse"
                                            class="form-control datetime-picker" placeholder="YYYY-MM-DD HH:mm">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">ATD Whs Dispatch <span class="text-muted small">- Berangkat Dari WH</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                        <input type="text" name="atd_whs_dispatch" id="track_atd_whs_dispatch"
                                            class="form-control datetime-picker" placeholder="YYYY-MM-DD HH:mm">
                                    </div>
                                </div>
                                ...
                                <!-- BARIS 2 -->
                                <div class="col-md-6">
                                    <label class="form-label">ATD Pool Dispatch <span class="text-muted small">- Berangkat Dari Pool</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                        <input type="text" name="atd_pool_dispatch" id="track_atd_pool_dispatch"
                                            class="form-control datetime-picker" placeholder="YYYY-MM-DD HH:mm">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">ATA Mover on Site <span class="text-muted small">- Mover Onsite</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                        <input type="text" name="ata_mover_on_site" id="track_ata_mover_on_site"
                                            class="form-control datetime-picker" placeholder="YYYY-MM-DD HH:mm">
                                    </div>
                                </div>
                                ...
                                <!-- BARIS 3 -->
                                <div class="col-md-6">
                                    <label class="form-label">Receiver on Site DateTime <span class="text-muted small">- PIC Onsite</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                        <input type="text" name="receiver_on_site_datetime" id="track_receiver_on_site_datetime"
                                            class="form-control datetime-picker" placeholder="YYYY-MM-DD HH:mm">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">POD DateTime <span class="text-muted small">- Handover Date</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                        <input type="text" name="pod_datetime" id="track_pod_datetime"
                                            class="form-control datetime-picker" placeholder="YYYY-MM-DD HH:mm">
                                    </div>
                                </div>
