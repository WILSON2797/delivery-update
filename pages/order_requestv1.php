                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="datetime-local" name="truck_on_warehouse" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">(Date & Time mover dispatch from Whs)</label>
                                    <input type="datetime-local" name="atd_whs_dispatch" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">(Date & Time mover dispatch from pool)</label>
                                    <input type="datetime-local" name="atd_pool_dispatch" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">ATA Mover on Site</label>
                                    <input type="datetime-local" name="ata_mover_on_site" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Receiver on Site DateTime</label>
                                    <input type="datetime-local" name="receiver_on_site_datetime" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">POD DateTime</label>
                                    <input type="datetime-local" name="pod_datetime" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status" class="form-select">
                                        ...
                                        <option value="Done Loading At WH">Done Loading At WH</option>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label">Truck on Warehouse</label>
                                    <input type="datetime-local" name="truck_on_warehouse" id="edit_truck_on_warehouse" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">ATD (Date & Time mover dispatch from Whs)</label>
                                    <input type="datetime-local" name="atd_whs_dispatch" id="edit_atd_whs_dispatch" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">ATD (Date & Time mover dispatch from Pool)</label>
                                    <input type="datetime-local" name="atd_pool_dispatch" id="edit_atd_pool_dispatch" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">ATA Mover on Site</label>
                                    <input type="datetime-local" name="ata_mover_on_site" id="edit_ata_mover_on_site" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Receiver on Site DateTime</label>
                                    <input type="datetime-local" name="receiver_on_site_datetime" id="edit_receiver_on_site_datetime" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">POD DateTime</label>
                                    <input type="datetime-local" name="pod_datetime" id="edit_pod_datetime" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <label class="form-label">Volume (m³)</label>
                                    <input type="number" step="0.01" name="volume" id="edit_volume" class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Gross Weight (kg)</label>
                                    <input type="number" step="0.01" name="gross_weight" id="edit_gross_weight" class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Type Shipment</label>
