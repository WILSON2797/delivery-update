...
<main>
    ...
    <div class="container-fluid px-4 mt-2">
        ...
        <!-- Chat Window — full width dengan max-width besar -->
        <div class="ta-card">
            ...
            <div class="ta-chat-header">
                ...
                <div>
                    ...
                    <div class="text-white-50" style="font-size:0.78rem;">
                        <span class="me-1">●</span>Online · Siap membantu
                    </div>
                </div>
                <div class="ms-auto">
                ...
                <div class="ta-msg-row" id="welcomeMsg">
                    ...
                    <div>
                        <div class="ta-bubble-bot">
                            Halo! 👋  Saya <strong>Apps Assistant. Dibuat Oleh Wilson Gurning</strong>.<br>
                            Silakan tanyakan Seputar Aplikasi ini . Misalnya:
                ...
                <div class="d-flex gap-2 align-items-end">
                    <div class="flex-grow-1">
                        <textarea id="chatInput"
                            class="ta-textarea"
                            placeholder="Ketik pertanyaan Anda di sini... (contoh: driver standby)"
                            rows="1"
