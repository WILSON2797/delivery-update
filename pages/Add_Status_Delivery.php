    ...
    <div class="container-fluid px-4 mt-4">
        <div class="card mb-4">
            <div class="card-header">
                ...
                <div class="float-end">
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#statusdeliveryModal">
            ...
            <div class="card-body" style="overflow-x: auto;">
                <div class="table-responsive" style="overflow-x: auto;">
                    <table class="table table-striped table-hover table-bordered compact-action" id="tabelstatusdelivery"
                        style="min-width: 100%; white-space: nowrap;">
                        <thead class="table-light">
                            <tr>
                                <th style="width: 80px;">No</th>
                                <th><strong>status delivery Name</strong></th>
                                <th>Created By</th>
...
<!-- Modal Tambah statusdelivery -->
<div class="modal fade" id="statusdeliveryModal" tabindex="-1" aria-labelledby="statusdeliveryModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="statusdeliveryModalLabel">Tambah status delivery</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="statusdeliveryForm" action="../modules/proses_statusdelivery.php" method="POST">
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <label class="form-label">status delivery Name</label>
