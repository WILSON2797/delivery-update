...
try {
    ...
    // UBAH: Sekarang wajib ada transaction_id, bukan id
    ...
    try {
        ...
        $params_daily = [
            ...
            $overnight_day,
            $update_by,
            $transaction_id  // UBAH: Pakai transaction_id
        ];
        ...
        if ($billing_exists) {
            ...
            // INSERT billing_details jika belum ada (untuk data lama yang belum punya transaction_id)
            ...
            if ($data) {
                ...
                $stmt_billing_insert->bind_param(
                    "sssssssddssss",
                    $transaction_id,                 // TAMBAH: transaction_id
                    $dn_number,
                    $data['sub_project'],
                    $data['plan_from'],
